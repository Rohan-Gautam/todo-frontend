    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-950 via-violet-900 to-indigo-900 relative overflow-hidden flex-col justify-between p-12">
                {/* Blobs */}
                <div className="absolute top-[-10%] right-[-10%] w-80 h-80 bg-violet-500/25 rounded-full blur-3xl animate-blob animation-delay-2000" />
                <div className="absolute bottom-[-10%] left-[-10%] w-80 h-80 bg-indigo-400/25 rounded-full blur-3xl animate-blob animation-delay-4000" />
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-white/60 text-lg mb-10">
                        Join Taskly and turn your ideas into action — one task at a time.
                    </p>
